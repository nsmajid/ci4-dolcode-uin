  <nav class="pcoded-navbar">
      ...
      <div class="pcoded-inner-navbar main-menu">
          ...
          <ul class="pcoded-item pcoded-left-item">
              <li class="<?= $nav == 'dashboard' ? 'active' : null ?>">
              ...
              <li class="<?= $nav == 'karyawan' ? 'active' : null ?>">
                  <a href="/admin/karyawan" class="waves-effect waves-dark">
                      <span class="pcoded-micon"><i class="ti-user"></i><b>D</b></span>
                      <span class="pcoded-mtext" data-i18n="nav.dash.main">Karyawan</span>
                      <span class="pcoded-mcaret"></span>
                  </a>
              </li>
              <li class="<?= $nav == 'jabatan' ? 'active' : null ?>">
                  <a href="/admin/jabatan" class="waves-effect waves-dark">
